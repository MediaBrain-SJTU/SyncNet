...
class Backbone(nn.Module):
    ...
    def __init__(self, height_feat_size, compress_level=0, LA_Flag=False):
        super().__init__()
    ...
    def encode(self, x):
        ...
        if self.compress_level > 0:
            x_3_compressed = F.relu(self.bn_compress(self.com_compresser(x_3)))
            x_3 = F.relu(self.bn_decompress(self.com_decompresser(x_3_compressed)))

        if self.LA_Flag == True and self.compress_level > 0:
            return [x, x_1, x_2, x_3, x_3_compressed, x_4]
        elif self.LA_Flag == True:
            return [x, x_1, x_2, x_3, x_3, x_4]
        else:
...
class LidarEncoder(Backbone):
    ...
    def __init__(self, height_feat_size=13, compress_level=0, LA_Flag=False):
        super().__init__(height_feat_size, compress_level, LA_Flag)
